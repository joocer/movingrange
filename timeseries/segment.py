...
class segment: 
    ...
    def describe(self):
        ...
        description = description + 'Items Above Mean = ' + str(matches(bins, lambda t: t > 0)) + '\n'
        description = description + 'Items Below Mean = ' + str(matches(bins, lambda t: t < 0)) + '\n'
        ...
        description = description + ' 3+ Sigma = (' + str(matches(bins, lambda t: t > 3)) + ' items)\n'
        description = description + ' 3  Sigma = ' + '{:.3f}'.format(self.individuals_standard_deviation(3)) + ' (' + str(matches(bins, lambda t: t == 3)) + ' items)\n'
        description = description + ' 2  Sigma = ' + '{:.3f}'.format(self.individuals_standard_deviation(2)) + ' (' + str(matches(bins, lambda t: t == 2)) + ' items)\n'
        description = description + ' 1  Sigma = ' + '{:.3f}'.format(self.individuals_standard_deviation(1)) + ' (' + str(matches(bins, lambda t: t == 1)) + ' items)\n'
